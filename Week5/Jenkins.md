...
Follow these instructions to configure **JDK**, **Maven**, and **Git** and link GitHub to  your Jenkins environment.
...
Click:
**Generate new token (*classic*)** See the screenshot below
